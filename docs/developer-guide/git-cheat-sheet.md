...
- [2. Configuration](#2-configuration)
  * [2.1. Global user settings](#21-global-user-settings)
  * [2.2. Ignoring files](#22-ignoring-files)
  * [2.3. Keeping files](#23-keeping-files)
- [3. Create a repository](#3-create-a-repository)
- [4. Daily work](#4-daily-work)
- [5. Checking out, branching, and merging](#5-checking-out-branching-and-merging)
- [6. Review change history](#6-review-change-history)
- [7. Tagging](#7-tagging)
- [8. Reverting changes](#8-reverting-changes)
- [9. Synchronizing repositories](#9-synchronizing-repositories)
...
## 5. Checking out, branching, and merging
