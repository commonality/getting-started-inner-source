...
> <img align="bottom" alt="book" height="50" width="56" src="https://cdnjs.cloudflare.com/ajax/libs/octicons/4.4.0/svg/book.svg"> The _Getting Started with InnerSource_ project's collection of "architecturally significant" decisions, i.e., those that affect the structure, non-functional characteristics, dependencies, interfaces, or construction techniques of this project's development, delivery, and maintenance.

## Index of ADRs

* [1. Record architecture decisions](0001-record-architecture-decisions.md)
* [2. Gitlab for Web-based SCM with DevSecOps integration](0002-gitlab-for-web-based-scm-with-devsecops-integration.md)
